...
def upgrade():
    ...
    with op.batch_alter_table("dag_code") as batch_op:
        ...
        batch_op.add_column(sa.Column("id", sa.types.UUID(), nullable=False))
        batch_op.create_primary_key("dag_code_pkey", ["id"])
        batch_op.add_column(sa.Column("dag_version_id", sa.types.UUID(), nullable=False))
    ...
    with op.batch_alter_table("task_instance", schema=None) as batch_op:
        batch_op.add_column(sa.Column("dag_version_id", sa.types.UUID()))
        batch_op.create_foreign_key(
    ...
    with op.batch_alter_table("dag_run", schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column("created_dag_version_id", sa.types.UUID(), nullable=True))
        batch_op.create_foreign_key(
