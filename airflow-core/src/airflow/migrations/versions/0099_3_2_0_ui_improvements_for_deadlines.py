...
def upgrade() -> None:
    ...
    op.create_table(
        "deadline_alert",
        sa.Column("id", sa.types.UUID(), default=uuid6.uuid7),
        sa.Column("created_at", UtcDateTime, nullable=False),
        sa.Column("serialized_dag_id", sa.types.UUID(), nullable=False),
    ...
    with op.batch_alter_table("deadline", schema=None) as batch_op:
        batch_op.add_column(sa.Column("deadline_alert_id", sa.types.UUID(), nullable=True))
